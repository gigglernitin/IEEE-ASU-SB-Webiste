...
<?php
	...
	$fpre= $conn->real_escape_string($_POST['fpre']);
	$spre = $conn->real_escape_string($_POST['spre']);
	...
	$query   = "INSERT into reg (name,email,fb,mob,fac,year,dep,fpre,spre,session) VALUES('" . $name . "','" . $email . "','" . $fb . "','" . $mob . "','" . $fac . "','" . $year . "','" . $dep . "','" . $fpre . "','" . $spre . "','" . $session . "')";
...
<h1>Thank You For Contacting Us ,<br>if you want, you can start <a href="pst.html">Your PST Now</a> </h1>
